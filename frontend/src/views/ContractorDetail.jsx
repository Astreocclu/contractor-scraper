import { Copy, Phone, Mail, Globe, MapPin, CheckCircle, XCircle, AlertTriangle, Star, Shield, Clock, Award } from "lucide-react"
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
export function ContractorDetailModal({ contractor, open, onOpenChange }) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">
                Trust Score: {contractor.trust_score}/100
              </div>
            </div>
          </div>
          {contractor.passes_threshold ? (
