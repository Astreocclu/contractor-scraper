/**
 * Cold Email Draft Factory - MOTORIZED SHADES
 *
 * Creates Gmail drafts for motorized shade/screen contractors in Fort Worth area.
...
You have 111 verified OUTDOOR STRUCTURE permit leads in Fort Worth area from the last 60 days. These are homeowners building patios, pergolas, and outdoor living spaces - PERFECT upsell targets for motorized shades and screens.

The data:
- 20 are HOT (permits filed in last 30 days) - construction in progress
- 37 are WARM (30-60 days old) - likely finishing up soon
- Fort Worth, Grapevine, Keller, Southlake area (affluent homeowners)
- Each lead includes: address, owner name, property value, permit date

These homeowners are ALREADY spending money on outdoor living. Motorized shades are the natural next step.

Pricing: $40/hot lead, $20/warm lead, or $2,500 for all 111

Write a quick cold email to ${businessName} in ${city}. They sell motorized shades/screens.

The vibe:
- You're not a slick salesman, you're just trying to move some leads
- Keep it SHORT (2-4 sentences)
- Emphasize these are homeowners ALREADY building outdoor spaces
...
{"subject": "short subject line", "body": "the email"}`;
  ...
  try {
    ...
    return {
      subject: `Homeowners building patios - shade upsells?`,
      body: `Got 111 homeowners in Fort Worth area currently building outdoor spaces. They're already spending money - perfect targets for motorized shades. Want 2-3 free samples to check quality?`
    };
  }
}
...
async function main() {
  console.log('\n========================================');
  console.log('  MOTORIZED SHADES EMAIL DRAFTS');
  console.log('  Fort Worth Area - 111 Patio Leads');
  console.log('========================================\n');
