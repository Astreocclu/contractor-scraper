/**
 * Cold Email Draft Factory - ROOFING
 *
 * Creates Gmail drafts for roofing contractors in Fort Worth area.
...
You have 142 verified RESIDENTIAL REMODEL permit leads in Fort Worth area from the last 60 days. Many of these homeowners are doing major renovations that need roofing work - new additions, storm damage repairs, full remodels.

The data:
- Fresh permits from Fort Worth, Grapevine, Keller area
- Homeowners actively spending money on renovations
- Each lead includes: address, owner name, property value, permit date
- Mix of additions, remodels, and structural work

Pricing: $35/lead or $3,500 for all 142

Write a quick cold email to ${businessName} in ${city}. They're a roofing contractor.

The vibe:
- You're not a slick salesman, you're just trying to move some leads
- Keep it SHORT (2-4 sentences)
- Emphasize these are homeowners ALREADY doing major work on their homes
...
{"subject": "short subject line", "body": "the email"}`;
  ...
  try {
    ...
    return {
      subject: `Fort Worth remodel permits - roofing leads?`,
      body: `Got 142 homeowners in Fort Worth area doing major remodels right now. Many need roofing work. Want 2-3 free samples to check quality?`
    };
  }
}
...
async function main() {
  console.log('\n========================================');
  console.log('  ROOFING CONTRACTOR EMAIL DRAFTS');
  console.log('  Fort Worth Area - 142 Remodel Leads');
  console.log('========================================\n');
